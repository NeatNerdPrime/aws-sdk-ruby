...
module Aws::WorkSpacesWeb
  describe EndpointProvider do
    ...
    context "For region cn-north-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://workspaces-web-fips.cn-north-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region cn-north-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://workspaces-web-fips.cn-north-1.amazonaws.com.cn"}}
      end
    ...
    context "For region cn-north-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://workspaces-web.cn-north-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region cn-north-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://workspaces-web.cn-north-1.amazonaws.com.cn"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://workspaces-web-fips.us-gov-east-1.api.aws"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://workspaces-web-fips.us-gov-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://workspaces-web.us-gov-east-1.api.aws"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://workspaces-web.us-gov-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-iso-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://workspaces-web-fips.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-iso-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://workspaces-web.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://workspaces-web-fips.us-isob-east-1.sc2s.sgov.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://workspaces-web.us-isob-east-1.sc2s.sgov.gov"}}
      end
