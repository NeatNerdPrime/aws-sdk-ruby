...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-invoicing'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Invoicing'
  spec.description   = 'Official AWS Ruby gem for AWS Invoicing. This gem is part of the AWS SDK for Ruby.'
