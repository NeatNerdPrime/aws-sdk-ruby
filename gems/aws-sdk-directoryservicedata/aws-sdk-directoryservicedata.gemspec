...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-directoryservicedata'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Directory Service Data'
  spec.description   = 'Official AWS Ruby gem for AWS Directory Service Data. This gem is part of the AWS SDK for Ruby.'
