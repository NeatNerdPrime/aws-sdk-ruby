...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-supplychain'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Supply Chain'
  spec.description   = 'Official AWS Ruby gem for AWS Supply Chain. This gem is part of the AWS SDK for Ruby.'
