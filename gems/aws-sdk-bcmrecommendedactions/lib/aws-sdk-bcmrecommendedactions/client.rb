...
module Aws::BCMRecommendedActions
  ...
  class Client < Seahorse::Client::Base
    ...
    @identifier = :bcmrecommendedactions
    ...
    add_plugin(Aws::BCMRecommendedActions::Plugins::Endpoints)
    ...
    #     sending the request.
    #
    #   @option options [Aws::BCMRecommendedActions::EndpointProvider] :endpoint_provider
    ...
    #
    # @option params [Types::RequestFilter] :filter
    ...
    #       actions: [
    #         {
    #           key: "FEATURE", # required, accepts FEATURE, SEVERITY, TYPE
    #           match_option: "EQUALS", # required, accepts EQUALS, NOT_EQUALS
    ...
    #   resp.recommended_actions[0].id #=> String
    #   resp.recommended_actions[0].type #=> String, one of "ADD_ALTERNATE_BILLING_CONTACT", "CREATE_ANOMALY_MONITOR", "CREATE_BUDGET", "ENABLE_COST_OPTIMIZATION_HUB", "MIGRATE_TO_GRANULAR_PERMISSIONS", "PAYMENTS_DUE", "PAYMENTS_PAST_DUE", "REVIEW_ANOMALIES", "REVIEW_BUDGET_ALERTS", "REVIEW_BUDGETS_EXCEEDED", "REVIEW_EXPIRING_RI", "REVIEW_EXPIRING_SP", "REVIEW_FREETIER_USAGE_ALERTS", "REVIEW_SAVINGS_OPPORTUNITY_RECOMMENDATIONS", "UPDATE_EXPIRED_PAYMENT_METHOD", "UPDATE_INVALID_PAYMENT_METHOD", "UPDATE_TAX_EXEMPTION_CERTIFICATE", "UPDATE_TAX_REGISTRATION_NUMBER"
    #   resp.recommended_actions[0].account_id #=> String
    #   resp.recommended_actions[0].severity #=> String, one of "INFO", "WARNING", "CRITICAL"
    #   resp.recommended_actions[0].feature #=> String, one of "ACCOUNT", "BUDGETS", "COST_ANOMALY_DETECTION", "COST_OPTIMIZATION_HUB", "FREE_TIER", "IAM", "PAYMENTS", "RESERVATIONS", "SAVINGS_PLANS", "TAX_SETTINGS"
    #   resp.recommended_actions[0].context #=> Hash
    #   resp.recommended_actions[0].context["String"] #=> String
    #   resp.recommended_actions[0].next_steps #=> Array
    #   resp.recommended_actions[0].next_steps[0] #=> String
    #   resp.recommended_actions[0].last_updated_time_stamp #=> String
    #   resp.next_token #=> String
    #
    # @see http://docs.aws.amazon.com/goto/WebAPI/bcm-recommended-actions-2024-11-14/ListRecommendedActions AWS API Documentation
    #
    ...
    def build_request(operation_name, params = {})
      ...
      tracer = config.telemetry_provider.tracer_provider.tracer(
        Aws::Telemetry.module_to_tracer_name('Aws::BCMRecommendedActions')
      )
