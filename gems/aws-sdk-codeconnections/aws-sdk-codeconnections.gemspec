...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-codeconnections'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS CodeConnections'
  spec.description   = 'Official AWS Ruby gem for AWS CodeConnections. This gem is part of the AWS SDK for Ruby.'
