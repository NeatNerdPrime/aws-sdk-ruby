...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-backupsearch'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Backup Search'
  spec.description   = 'Official AWS Ruby gem for AWS Backup Search. This gem is part of the AWS SDK for Ruby.'
