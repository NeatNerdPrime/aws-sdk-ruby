...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-gameliftstreams'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon GameLift Streams'
  spec.description   = 'Official AWS Ruby gem for Amazon GameLift Streams. This gem is part of the AWS SDK for Ruby.'
