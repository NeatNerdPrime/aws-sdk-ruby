...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-socialmessaging'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS End User Messaging Social'
  spec.description   = 'Official AWS Ruby gem for AWS End User Messaging Social. This gem is part of the AWS SDK for Ruby.'
