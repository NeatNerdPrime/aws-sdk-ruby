...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-mpa'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Multi-party Approval'
  spec.description   = 'Official AWS Ruby gem for AWS Multi-party Approval. This gem is part of the AWS SDK for Ruby.'
