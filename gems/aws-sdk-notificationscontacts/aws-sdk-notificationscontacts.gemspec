...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-notificationscontacts'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS User Notifications Contacts'
  spec.description   = 'Official AWS Ruby gem for AWS User Notifications Contacts. This gem is part of the AWS SDK for Ruby.'
