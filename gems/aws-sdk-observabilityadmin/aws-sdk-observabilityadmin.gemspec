...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-observabilityadmin'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - CloudWatch Observability Admin Service'
  spec.description   = 'Official AWS Ruby gem for CloudWatch Observability Admin Service. This gem is part of the AWS SDK for Ruby.'
