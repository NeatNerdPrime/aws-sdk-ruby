...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-route53profiles'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Route 53 Profiles'
  spec.description   = 'Official AWS Ruby gem for Route 53 Profiles. This gem is part of the AWS SDK for Ruby.'
