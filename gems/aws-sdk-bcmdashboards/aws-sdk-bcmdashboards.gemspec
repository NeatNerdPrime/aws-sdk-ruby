...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-bcmdashboards'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Billing and Cost Management Dashboards'
  spec.description   = 'Official AWS Ruby gem for AWS Billing and Cost Management Dashboards. This gem is part of the AWS SDK for Ruby.'
