...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-artifact'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Artifact'
  spec.description   = 'Official AWS Ruby gem for AWS Artifact. This gem is part of the AWS SDK for Ruby.'
