...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-geoplaces'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Location Service Places V2'
  spec.description   = 'Official AWS Ruby gem for Amazon Location Service Places V2. This gem is part of the AWS SDK for Ruby.'
