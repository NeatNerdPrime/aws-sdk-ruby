...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-pcs'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Parallel Computing Service'
  spec.description   = 'Official AWS Ruby gem for AWS Parallel Computing Service. This gem is part of the AWS SDK for Ruby.'
