...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-neptunegraph'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Neptune Graph'
  spec.description   = 'Official AWS Ruby gem for Amazon Neptune Graph (Neptune Graph). This gem is part of the AWS SDK for Ruby.'
