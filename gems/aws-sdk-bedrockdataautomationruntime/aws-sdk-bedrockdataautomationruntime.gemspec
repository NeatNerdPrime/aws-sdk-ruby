...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-bedrockdataautomationruntime'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Runtime for Amazon Bedrock Data Automation'
  spec.description   = 'Official AWS Ruby gem for Runtime for Amazon Bedrock Data Automation. This gem is part of the AWS SDK for Ruby.'
