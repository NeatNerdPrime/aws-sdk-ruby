...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-controlcatalog'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Control Catalog'
  spec.description   = 'Official AWS Ruby gem for AWS Control Catalog. This gem is part of the AWS SDK for Ruby.'
