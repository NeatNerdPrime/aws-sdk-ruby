...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-networkflowmonitor'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Network Flow Monitor'
  spec.description   = 'Official AWS Ruby gem for Network Flow Monitor. This gem is part of the AWS SDK for Ruby.'
