...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-ssmguiconnect'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS SSM-GUIConnect'
  spec.description   = 'Official AWS Ruby gem for AWS SSM-GUIConnect. This gem is part of the AWS SDK for Ruby.'
