...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-iotmanagedintegrations'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Managed integrations for AWS IoT Device Management'
  spec.description   = 'Official AWS Ruby gem for Managed integrations for AWS IoT Device Management. This gem is part of the AWS SDK for Ruby.'
