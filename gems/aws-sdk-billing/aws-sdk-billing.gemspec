...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-billing'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Billing'
  spec.description   = 'Official AWS Ruby gem for AWS Billing. This gem is part of the AWS SDK for Ruby.'
