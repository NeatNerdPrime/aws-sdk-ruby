...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-workspacesinstances'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Workspaces Instances'
  spec.description   = 'Official AWS Ruby gem for Amazon Workspaces Instances. This gem is part of the AWS SDK for Ruby.'
