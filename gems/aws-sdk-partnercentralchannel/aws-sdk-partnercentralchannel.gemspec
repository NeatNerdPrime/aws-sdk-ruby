...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-partnercentralchannel'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Partner Central Channel API'
  spec.description   = 'Official AWS Ruby gem for Partner Central Channel API. This gem is part of the AWS SDK for Ruby.'
