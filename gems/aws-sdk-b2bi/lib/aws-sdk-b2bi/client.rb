...
module Aws::B2bi
  ...
  class Client < Seahorse::Client::Base
    ...
    #                 },
    #                 element_requirement_validation_rule: {
    #                   element_position: "ElementPosition", # required
    #                   requirement: "OPTIONAL", # required, accepts OPTIONAL, MANDATORY
    #                 },
    #               },
    #             ],
    #           },
    ...
    #   resp.input_conversion.advanced_options.x12.validation_options.validation_rules #=> Array
    #   resp.input_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.element_id #=> String
    #   resp.input_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_add #=> Array
    #   resp.input_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_add[0] #=> String
    #   resp.input_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_remove #=> Array
    #   resp.input_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_remove[0] #=> String
    #   resp.input_conversion.advanced_options.x12.validation_options.validation_rules[0].element_length_validation_rule.element_id #=> String
    #   resp.input_conversion.advanced_options.x12.validation_options.validation_rules[0].element_length_validation_rule.max_length #=> Integer
    #   resp.input_conversion.advanced_options.x12.validation_options.validation_rules[0].element_length_validation_rule.min_length #=> Integer
    #   resp.input_conversion.advanced_options.x12.validation_options.validation_rules[0].element_requirement_validation_rule.element_position #=> String
    #   resp.input_conversion.advanced_options.x12.validation_options.validation_rules[0].element_requirement_validation_rule.requirement #=> String, one of "OPTIONAL", "MANDATORY"
    ...
    #   resp.output_conversion.advanced_options.x12.split_options.split_by #=> String, one of "NONE", "TRANSACTION"
    #   resp.output_conversion.advanced_options.x12.validation_options.validation_rules #=> Array
    #   resp.output_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.element_id #=> String
    #   resp.output_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_add #=> Array
    #   resp.output_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_add[0] #=> String
    #   resp.output_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_remove #=> Array
    #   resp.output_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_remove[0] #=> String
    #   resp.output_conversion.advanced_options.x12.validation_options.validation_rules[0].element_length_validation_rule.element_id #=> String
    #   resp.output_conversion.advanced_options.x12.validation_options.validation_rules[0].element_length_validation_rule.max_length #=> Integer
    #   resp.output_conversion.advanced_options.x12.validation_options.validation_rules[0].element_length_validation_rule.min_length #=> Integer
    #   resp.output_conversion.advanced_options.x12.validation_options.validation_rules[0].element_requirement_validation_rule.element_position #=> String
    #   resp.output_conversion.advanced_options.x12.validation_options.validation_rules[0].element_requirement_validation_rule.requirement #=> String, one of "OPTIONAL", "MANDATORY"
    ...
    #   resp.transformers[0].input_conversion.advanced_options.x12.validation_options.validation_rules #=> Array
    #   resp.transformers[0].input_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.element_id #=> String
    #   resp.transformers[0].input_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_add #=> Array
    #   resp.transformers[0].input_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_add[0] #=> String
    #   resp.transformers[0].input_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_remove #=> Array
    #   resp.transformers[0].input_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_remove[0] #=> String
    #   resp.transformers[0].input_conversion.advanced_options.x12.validation_options.validation_rules[0].element_length_validation_rule.element_id #=> String
    #   resp.transformers[0].input_conversion.advanced_options.x12.validation_options.validation_rules[0].element_length_validation_rule.max_length #=> Integer
    #   resp.transformers[0].input_conversion.advanced_options.x12.validation_options.validation_rules[0].element_length_validation_rule.min_length #=> Integer
    #   resp.transformers[0].input_conversion.advanced_options.x12.validation_options.validation_rules[0].element_requirement_validation_rule.element_position #=> String
    #   resp.transformers[0].input_conversion.advanced_options.x12.validation_options.validation_rules[0].element_requirement_validation_rule.requirement #=> String, one of "OPTIONAL", "MANDATORY"
    ...
    #   resp.transformers[0].output_conversion.advanced_options.x12.split_options.split_by #=> String, one of "NONE", "TRANSACTION"
    #   resp.transformers[0].output_conversion.advanced_options.x12.validation_options.validation_rules #=> Array
    #   resp.transformers[0].output_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.element_id #=> String
    #   resp.transformers[0].output_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_add #=> Array
    #   resp.transformers[0].output_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_add[0] #=> String
    #   resp.transformers[0].output_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_remove #=> Array
    #   resp.transformers[0].output_conversion.advanced_options.x12.validation_options.validation_rules[0].code_list_validation_rule.codes_to_remove[0] #=> String
    #   resp.transformers[0].output_conversion.advanced_options.x12.validation_options.validation_rules[0].element_length_validation_rule.element_id #=> String
    #   resp.transformers[0].output_conversion.advanced_options.x12.validation_options.validation_rules[0].element_length_validation_rule.max_length #=> Integer
    #   resp.transformers[0].output_conversion.advanced_options.x12.validation_options.validation_rules[0].element_length_validation_rule.min_length #=> Integer
    #   resp.transformers[0].output_conversion.advanced_options.x12.validation_options.validation_rules[0].element_requirement_validation_rule.element_position #=> String
    #   resp.transformers[0].output_conversion.advanced_options.x12.validation_options.validation_rules[0].element_requirement_validation_rule.requirement #=> String, one of "OPTIONAL", "MANDATORY"
    ...
    #   * {Types::TestParsingResponse#validation_messages #validation_messages} => Array&lt;String&gt;
    #
    #
    ...
    #   }
    #
    # @example Example: Sample TestParsing call with Validation Options
    #
    #   resp = client.test_parsing({
    #     advanced_options: {
    #       x12: {
