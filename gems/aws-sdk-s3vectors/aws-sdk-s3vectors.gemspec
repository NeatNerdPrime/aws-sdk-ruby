...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-s3vectors'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon S3 Vectors'
  spec.description   = 'Official AWS Ruby gem for Amazon S3 Vectors. This gem is part of the AWS SDK for Ruby.'
