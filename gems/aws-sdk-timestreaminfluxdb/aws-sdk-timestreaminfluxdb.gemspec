...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-timestreaminfluxdb'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Timestream InfluxDB'
  spec.description   = 'Official AWS Ruby gem for Timestream InfluxDB. This gem is part of the AWS SDK for Ruby.'
