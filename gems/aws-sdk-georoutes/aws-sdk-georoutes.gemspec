...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-georoutes'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Location Service Routes V2'
  spec.description   = 'Official AWS Ruby gem for Amazon Location Service Routes V2. This gem is part of the AWS SDK for Ruby.'
