...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-securityir'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Security Incident Response'
  spec.description   = 'Official AWS Ruby gem for Security Incident Response. This gem is part of the AWS SDK for Ruby.'
