...
Gem::Specification.new do |spec|
  ...
  spec.description   = '[DEPRECATED] Official AWS Ruby gem for Amazon Lookout for Metrics (LookoutMetrics). This gem is part of the AWS SDK for Ruby.'
  ...
  spec.post_install_message = '*** aws-sdk-lookoutmetrics is deprecated ***'
end
