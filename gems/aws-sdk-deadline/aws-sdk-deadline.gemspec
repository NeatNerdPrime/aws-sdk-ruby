...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-deadline'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWSDeadlineCloud'
  spec.description   = 'Official AWS Ruby gem for AWSDeadlineCloud. This gem is part of the AWS SDK for Ruby.'
